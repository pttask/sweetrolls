const data = {
    banana: {
        ...
        bgClass: "bg-banana",
        imgSrc: "/static/img/banana.png" // Ganti dengan path gambarmu
    },
    choco: {
        title: "CHOCO ROLLS",
        desc: "Soft Banana, Rich Chocolate<br>Perfectly Rolled",
        bgClass: "bg-choco",
        imgSrc: "/static/img/banana choco.png" // Ganti dengan path gambarmu
    },
    cheese: {
        title: "CHEESE ROLLS",
        desc: "Sweet Banana, Creamy Cheese<br>Perfect Golden",
        bgClass: "bg-cheese",
        imgSrc: "static/img/banana cheese.png" // Ganti dengan path gambarmu
    }
};
